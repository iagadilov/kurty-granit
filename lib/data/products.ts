...
const hardcodedSizes: Record<string, string[]> = {
  ...
  // Блоки: объём вместо размера (в прайсе только м³, габаритов нет)
  'bloki': [
    'Блоки 1 категории — от 2 до 6 м³',
    'Блоки 2 категории — от 2 до 6 м³',
    'Заказные блоки — по запросу',
  ],
  // Бордюры: стандартные обозначения ГП, длина произвольная (L)
  // Сортировка по площади сечения возрастающей
  'granitnye-bordjury': [
    'ГП-5 — 200×80×L',    // 16 000 мм²
    'ГП-4 — 200×100×L',   // 20 000 мм²
    'ГП-6 — 200×150×L',   // 30 000 мм²
    'ГП-1 — 300×150×L',   // 45 000 мм²
    'ГП-2 — 400×180×L',   // 72 000 мм²
    'ГП-3 — 600×200×L',   // 120 000 мм²
  ],
};
